...
export const Listeners = (props) => (
  <section className={`section ${props.active === props.title ? 'section--current' : ''}`}>
    <div className="section__content">
      <h2 className="section__title">Listeners</h2>
      <p className="section__description"><span className="section__description-inner">Listen and Earn. Stream and Support.</span></p>
    </div>
    <div className="section__img">
    <div className="section__img-inner">
        <video autoPlay loop>
          <source src="/rockConcert.mp4" type="video/mp4" />
    ...
    <div className="section__more">
      <div className="section__more-inner section__more-inner--bg1">
        ...
        <Link to='/users/signup' className="section__more-link">
          <span className="section__more-linktext">Sign Up</span>
