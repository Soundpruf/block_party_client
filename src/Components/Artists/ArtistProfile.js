...
export default class Profile extends Component {
    ...
    getCurrentArtist() {
        ...
        const URL = process.env.NODE_ENV === 'development' ? `http://localhost:5000/artists/${artist_id}/onboard` : 'https://block-party-staging-server.herokuapp.com/' + `artists/${artist_id}/onboard`
    ...
    onPhotoDrop(photo) {
        ...
        photo.forEach((file) => {
            ...
            // CREATE ROUTE FOR ADDING A PROFILE IMAGE TO ARTIST
                            ...
                            <Grid>
                                ...
                                <Grid.Column width={4}>
                                    <Menu fluid vertical tabular='right'>
                                        <Menu.Item name='Onboard' active={activeItem === 'Onboard'} onClick={this.handleItemClick} />
                                        <Menu.Item name='bio' active={activeItem === 'bio'} onClick={this.handleItemClick} />
                                        <Menu.Item name='vids' active={activeItem === 'vids'} onClick={this.handleItemClick} />
