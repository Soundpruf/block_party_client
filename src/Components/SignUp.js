...
export default class SignUp extends Component {
    ...
    login(callback) {
        ...
        const REDIRECT_URI = process.env.NODE_ENV === 'development' ? 'http://localhost:3000/users/signup/callback/' : 'https://block-party-staging-client.herokuapp.com/users/signup/callback/'
        const scopes = [
